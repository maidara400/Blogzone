    ...
    <main class="min-vh-100 d-flex justify-content-center align-items-center " >
         <div class="container mt-5 pt-3 d-flex justify-content-center align-items-center ">
            <div class="shadow-lg card p-3  overflow-hidden " style="width: 28rem; height: 35rem; max-height: 600px; background-color: rgb(51, 51, 51);">
                <div class="card-title fw-bold text-light text-center my-3 h3">Ajouter Article</div>
                <form action="../../../App/Controller/article.php" method="POST" enctype="multipart/form-data">
                    <div class="form-floating mb-5">
                        <input type="text" class="form-control bg-transparent text-light border-0" id="floatingInput" placeholder="Titre de l article" name="titre" required>
                        <label for="floatingInput">Titre</label>
                    </div>

                    <textarea name="description" class="form-control my-3 border-0 bg-light mb-3" rows="3" placeholder="Decrivez l article ..." style="resize: none; width: 25rem; height: 10rem;"></textarea>
                    ...
                    <input type="submit" class="border-0 btn btn-primary  text-light  w-100"  name="ajouter" value="Ajouter">
                </form>
            </div>
        </div>
