<?php ob_start()  ?>
    ...
    <div aria-live="polite" aria-atomic="true"
            class="position-relative w-100 d-flex justify-content-center align-items-center "
            style="margin-top: 5rem; height: 50vh;">
        <div class="toast show bg-transparent overflow-hidden"
            role="alert" aria-live="assertive" aria-atomic="true"
            style="width: 75%; max-width: 650px;">
            <div class="position-relative w-100">
                <img src="../../Public/image/medicament.jpg"
                    class="img-fluid w-100 " alt="Publicité médicament" style="opacity: 0.5;">        
                <button type="button" class="btn-close position-absolute top-0 end-0 m-2"
                        data-bs-dismiss="toast" aria-label="Fermer" data-bs-theme="dark">
                </button>
                <p class="position-absolute top-0 end-25  text-light fs-5">Titre LOREM10.</p>
            </div>
        </div>
    </div>
